...
export declare type XYGeom = 'line' | 'step' | 'stacked' | 'bar' | 'monotoneX' | 'stepBefore' | 'stepAfter';
...
export declare type SchemaType = 'implicit' | 'explicit';
/**
...
export declare type BucketMetadataManifests = BucketMetadataManifest[];
...
export declare type ShardGroupManifests = ShardGroupManifest[];
